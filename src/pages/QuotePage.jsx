    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-6xl mx-auto my-12 p-0 flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 flex justify-center">
          <img src="https://proactivecleaners.co.uk/wp-content/uploads/2022/05/IMG_20220510_181441-scaled.jpg" alt="Bespoke Cleaning" className="rounded-2xl w-full max-w-md object-cover" />
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto my-12 p-0 flex flex-col md:flex-row items-center md:flex-row-reverse">
        <div className="flex-1 flex justify-center">
          <img src="https://proactivecleaners.co.uk/wp-content/uploads/2022/05/IMG_20220510_181441-scaled.jpg" alt="Quotes For Cleaning" className="rounded-2xl w-full max-w-md object-cover" />
        </div>
        <div className="flex-1 p-8">
