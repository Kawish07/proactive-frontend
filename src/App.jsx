...
import SectorsCTA from './pages/SectorCTA';
...
const App = () => (
  <Router>
    <Helmet>
      ...
      <meta name="description" content="Expert commercial, industrial, and specialist cleaning for your business. Get a free quote today!" />
      <meta name="keywords" content="cleaning, commercial cleaning, industrial cleaning, specialist cleaning, COVID-19 cleaning" />
    ...
    <main>
      <Routes>
        ...
        <Route path="/location/:locationId" element={<LocationPages />} />
        <Route path="/sector" element={<SectorsCTA />} />
  ...
  className="fixed bottom-8 right-8 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-colors flex items-center justify-center"
    ...
    >
  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" style={{ zIndex: 2 }}>
